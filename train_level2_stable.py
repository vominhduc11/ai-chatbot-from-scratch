...
MODEL_PATH = ARTIFACT_DIR / "level2_stable_model.pt"
METADATA_PATH = ARTIFACT_DIR / "level2_stable_metadata.json"
...
def main():
    print("=== LEVEL 2 STABLE TRAINING START ===")
    ...
    print("=== LEVEL 2 STABLE TRAINING DONE ===")
